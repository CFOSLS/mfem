...
MFEM_DEPENDENCIES = LIBUNWIND SIDRE LAPACK OPENMP SUNDIALS MESQUITE SUITESPARSE \
 SUPERLU STRUMPACK GECKO GNUTLS NETCDF PETSC MPFR MARS
...
MFEM_DEFINES = MFEM_VERSION MFEM_USE_MPI MFEM_USE_METIS_5 MFEM_DEBUG\
 ...
 MFEM_USE_MPFR MFEM_USE_SIDRE MFEM_USE_MARS
...
DIRS = general linalg mesh fem cfosls
...
status info:
	...
	$(info MFEM_USE_MARS        = $(MFEM_USE_MARS))
